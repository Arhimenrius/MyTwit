...
use MyTwit\MyTwitBundle\Entity\Config;

/**
 * @Annotation Helper to create configuration
 */
...
class ConfigHelper
{
    ...
    /**
     * 
     * @return array Return all config options from DB
     */
    public function getAllOptions()
    {
        $options = $this->_em->getRepository('MyTwitMyTwitBundle:Config')->findAll();
        $data = array();
    ...
    /**
     * 
     * @return array Return one config option from DB
     */
    public function getOneOption($name)
    {
        $result = $this->_em->getRepository('MyTwitMyTwitBundle:Config')->findBy(array('name' => $name));
        return $result;
    }
    
    /**
     * 
     * @return boolean Looking for exist user
     */
    ...
    /**
     * 
     * @return string Return ecnrypted password
     */
    ...
    /**
     * 
     * @return array Set all config options to temporary memory
     */
    ...
    /**
     * 
     * @return array Return all enabled options to config
     */
    ...
    /**
     * 
     * @return array Save options to DB
     */
    ...
    public function save($data)
    {
        foreach($data as $key => $value)
        {
            ...
            else
            {
                ...
                $config = $this->_em->getRepository('MyTwitMyTwitBundle:Config')->findOneBy(array('name' => $to_db['Name']));
                $config->setName($to_db['Name']);
